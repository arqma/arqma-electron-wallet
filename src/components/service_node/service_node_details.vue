          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatArqma :amount="node.staking_requirement" raw-value/></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatArqma :amount="node.total_contributed" raw-value/></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
            ...
            >
              <q-item-label>
                ...
                <q-item-label class="non-selectable" caption>
                  ...
                  <FormatArqma :amount="contributor.amount" raw-value />
                </q-item-label>
              </q-item-label>
